...
const FlexHoarding = () => {
  ...
  const images = [
    { src: 'fh1.jpg', alt: 'Image 1' },
    { src: 'fh2.jpg', alt: 'Image 2' },
    { src: 'fh3.jpg', alt: 'Image 3' },
    { src: 'fh4.jpg', alt: 'Image 4' },
    { src: 'fh5.jpg', alt: 'Image 5' },
    { src: 'fh6.jpg', alt: 'Image 6' },
  ];
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.title}>Flex Hoarding</h1>
      <div
