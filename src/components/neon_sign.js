...
const NeonSign = () => {
  ...
  const images = [
    { src: 'ns3.jpg', alt: 'Image 1' },
    { src: 'ns2.jpg', alt: 'Image 2' },
    { src: 'ns1.jpg', alt: 'Image 3' },
    { src: 'ns4.jpg', alt: 'Image 4' },
    { src: 'ns5.jpg', alt: 'Image 5' },
    { src: 'ns6.jpg', alt: 'Image 6' },
  ];
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.title}>Neon Glow Sign Boards</h1>
      <div
