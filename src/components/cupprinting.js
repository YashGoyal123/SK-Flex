...
const CupPrinting = () => {
  ...
  const images = [
    { src: 'c1.jpg', alt: 'Image 1' },
    { src: 'c2.jpg', alt: 'Image 2' },
    { src: 'c3.jpg', alt: 'Image 3' },
    { src: 'c4.jpg', alt: 'Image 4' },
    { src: 'c5.jpg', alt: 'Image 5' },
    { src: 'c6.jpg', alt: 'Image 6' },
  ];
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.title}>Cup Printing</h1>
      <div
