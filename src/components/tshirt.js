...
const TshirtPrinting = () => {
  ...
  const images = [
    { src: 't1.jpg', alt: 'Image 1' },
    { src: 't2.jpg', alt: 'Image 2' },
    { src: 't3.jpg', alt: 'Image 3' },
    { src: 't4.jpg', alt: 'Image 4' },
    { src: 't5.jpg', alt: 'Image 5' },
    { src: 't6.png', alt: 'Image 6' },
  ];
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.title}>T-Shirt Printing</h1>
      <div
