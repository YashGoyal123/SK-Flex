...
const StainlessSteel = () => {
  ...
  const images = [
    { src: 'ssteel6.avif', alt: 'Image 6' },
    { src: 'ssteel1.avif', alt: 'Image 1' },
    { src: 'ssteel2.avif', alt: 'Image 2' },
    { src: 'ssteel3.avif', alt: 'Image 3' },
    { src: 'ssteel4.avif', alt: 'Image 4' },
    { src: 'ssteel5.avif', alt: 'Image 5' },
  ];
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.title}>Stainless Steel Letters</h1>
      <div
