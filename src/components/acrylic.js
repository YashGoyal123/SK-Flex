...
const Acrylic = () => {
  ...
  const images = [
    { src: 'acr1.jpg', alt: 'Image 1' },
    { src: 'acr2.jpg', alt: 'Image 2' },
    { src: 'acr3.jpg', alt: 'Image 3' },
    { src: 'acr4.jpg', alt: 'Image 4' },
    { src: 'acr5.jpg', alt: 'Image 5' },
    { src: 'acr6.png', alt: 'Image 6' },
  ];
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.title}>Acrylic Letters</h1>
      <div
