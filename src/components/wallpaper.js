...
const Wallpaper = () => {
  ...
  const images = [
    { src: 'w1.jpg', alt: 'Image 1' },
    { src: 'w2.jpg', alt: 'Image 2' },
    { src: 'w3.jpg', alt: 'Image 3' },
    { src: 'w4.jpg', alt: 'Image 4' },
    { src: 'w5.jpg', alt: 'Image 5' },
    { src: 'w6.jpg', alt: 'Image 6' },
  ];
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.title}>3D Wallpapers</h1>
      <div
