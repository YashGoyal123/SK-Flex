...
const AcpElevation = () => {
  ...
  const images = [
    { src: 'acp1.jpg', alt: 'Image 1' },
    { src: 'acp2.jpg', alt: 'Image 2' },
    { src: 'acp3.jpg', alt: 'Image 3' },
    { src: 'acp4.jpg', alt: 'Image 4' },
    { src: 'acp5.jpg', alt: 'Image 5' },
    { src: 'acp6.jpg', alt: 'Image 6' },
  ];
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.title}>ACP Elevation</h1>
      <div
